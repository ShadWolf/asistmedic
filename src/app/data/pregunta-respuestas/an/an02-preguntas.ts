...
al estar en movimiento libera endorfinas que son sustancias que alivian el dolor y mejoran \
el ánimo. Ejercicios suaves como caminar o estiramientos, pueden ayudar.'
  },
  {
    codigo: 'AN02',
  ...
  },
  {
    ...
    respuesta: 'El estrés puede aumentar la intensidad del dolor. Tú cuerpo libera ciertas \
sustancias que provocan que el dolor se sienta más intenso. Además puede provocar que te \
enfoques más en el dolor en si lo que puede causar que sea más molesto.'
  },
  {
    codigo: 'AN02',
    pregunta: 'La respiración profunda puede disminuir el dolor',
    respuesta: 'Está comprobado que la técnica de respirar profundamente, disminuye el \
dolor, puede realizarlo de manera lenta, tranquila, respirando por la nariz y botando por la boca.'
  }
];
